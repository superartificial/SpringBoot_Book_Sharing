...
public class BookService {
    ...
    public Integer returnBook(Integer bookId, Authentication connectedUser) {
        ...
        // transactionHistoryRepository.isAlreadyBorrowedByUser(book.getId(),
        // user.getId());
        // if(!isAlreadyBorrowed) {
        // throw new OperationNotPermittedException("You do not have this book
        // borrowed");
        // }
    ...
    public Integer approveBookReturn(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = transactionHistoryRepository
                ...
                .orElseThrow(() -> new OperationNotPermittedException(
                        "Return approval failed because the book has not been returned."));
